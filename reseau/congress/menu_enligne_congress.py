...
class MenuPrincipal:
    def __init__(self):
        ...
        pygame.display.set_caption("Congress - Menu Principal")
    ...
    def dessiner_interface(self):
        ...
        # Sous-titre
        sous_titre = "Jeu de Strategie en Reseau"
        ...
        instructions = [
            ...
            "Rassemblez tous vos pions pour gagner!"
        ]
        
        y_instructions = self.HAUTEUR - int(180 * self.RATIO_Y)
    ...
    def lancer_guest(self):
        ...
        subprocess.Popen([sys.executable, "reseau/congress/congress_guest.py"])
        sys.exit()
